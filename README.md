...
> 提醒： Hk 已经封禁本专案，请 Fork 本专案后，将 README.md 中的 用户名 替换为 自己的用户名

> 务必修改 专案名称 不要出现(Hk、Xy、Vy)等字符，再进行部署。 
...
* 请求`/test/`，文件下载速度测试
* 请求`/ray`（可配置）vy websocket路径

## 服务端

[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/antixxxxp/hkvy) 
...
### 环境变量说明
 ...
 | 名称     | 值                                                           | 说明                                                         |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 协议 | vm/vl（可选）                                               | 协议：nginx+vmess+ws+tls或是nginx+vless+ws+tls                |
...
出于安全考量，除非使用 CDN，否则请不要使用自定义域名，而使用 Hk 分配的二级域名，以实现 Xy vl Websocket + TLS。
...
```js
const SingleDay = 'app1.h*kuapp.com'
const DoubleDay = 'app2.h*kuapp.com'
addEventListener(
    "fetch",event => {
...
```js
const Day0 = 'app0.h*kuapp.com'
const Day1 = 'app1.h*kuapp.com'
const Day2 = 'app2.h*kuapp.com'
const Day3 = 'app3.h*kuapp.com'
const Day4 = 'app4.h*kuapp.com'
addEventListener(
    "fetch",event => {
...
const Day3 = 'app3.h*kuapp.com'
const Day4 = 'app4.h*kuapp.com'
const Day5 = 'app5.h*kuapp.com'
const Day6 = 'app6.h*kuapp.com'
addEventListener(
    "fetch",event => {
